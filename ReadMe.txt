...
Note: If you are using ARC, use the following code instead:
	/*.h*/ @property (nonatomic, strong) CodeRedeemer *cRedeemer;
	/*.m*/ @synthesize cRedeemer;
 	       cRedeemer = [CodeRedeemer alloc];
